...
[![Live Demo](https://img.shields.io/badge/Demo-Live-green)](https://rizwan-ullah-tech.github.io/MCQ-Generator/)
...
Install and run:
```bash
git clone https://github.com/Rizwan-Ullah-tech/MCQ-Generator.git
cd MCQGenius
...
3. Site available at https://rizwan-ullah-tech.github.io/MCQ-Generator/
